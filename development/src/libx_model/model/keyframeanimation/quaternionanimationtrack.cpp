...
)
{
	...
	if (frame1 == frame2)
	{
		animated_quaternion_->SetAnimatedQuaternion(keyframes_[frame1], channel_);
	}
	else
	{
		...
		animated_quaternion_->SetAnimatedQuaternion(interpolated, channel_);
	}
}
