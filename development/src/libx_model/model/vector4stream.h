...
//-----------------------------------------------------------------------------------------------------------
/*!	\file model/vector4stream.h
	\brief Definition von x::model::Vector4Stream
	\version 0.1
	\date 21.9.2003
	\author Christian Oberholzer

	Definition von x::model::Vector4Stream
*/
//-----------------------------------------------------------------------------------------------------------
#ifndef MODEL_VECTOR4STREAM_H
#define MODEL_VECTOR4STREAM_H
...
/*!
*/
class Vector4Stream : public Stream
{
public:
	Vector4Stream();
	virtual ~Vector4Stream();

	// Daten setzen
	virtual void SetSemantics(const SemanticTypes semantics);
	virtual void SetSemanticsInfo(const uint_t semantics_info);
	virtual void SetData(const uint_t element_count, math::Vector4f* data);

	// Informationen über den Vector4Stream
...
protected:
	...
	math::Vector4f* array_;
	bool_t is_dirty_;
};

}} // namespace x::model

#endif // MODEL_VECTOR4STREAM_H
