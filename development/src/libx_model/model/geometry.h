...
public:
	...
	virtual Vector4Stream* CreateDefaultVector4Stream() const;
	...
	virtual Stream* AddVector4Stream(const SemanticTypes semantics, const uint_t semantics_info, const uint_t element_count, math::Vector4f* data);
