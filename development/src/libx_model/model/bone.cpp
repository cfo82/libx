...
)
{
	switch (channel)
	{
	case ChannelTranslation:	SetTranslate(v); break;
	case ChannelScale:			SetScale(v); break;
	default: throw Exception("invalid channel given");
	}
}
...
)
{
	...
	{
		throw Exception("invalid channel given");
	}
...
)
{
	...
	math::Matrix4x4f transformation_matrix = translate * rotation.ToMatrix4x4() * scale.ToMatrix4x4();
	if (parent != NULL)
	{
