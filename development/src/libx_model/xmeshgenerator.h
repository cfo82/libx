...
protected:
	...
	bool_t LoadSkeleton(model::Model* mesh, x::templates::Frame* x_frame, vector<string_t>& referenced_frames);
	...
	void ApplyRotationAnimationKeyTemplate(x::templates::AnimationKey* x_animation_key, const string_t& referenced_bone, model::Skeleton* skeleton, model::Animation* animation, const dword_t frame_diff, const dword_t last_frame_time);
	void ApplyScaleAnimationKeyTemplate(x::templates::AnimationKey* x_animation_key, const string_t& referenced_bone, model::Skeleton* skeleton, model::Animation* animation, const dword_t frame_diff, const dword_t last_frame_time);
	void ApplyPositionAnimationKeyTemplate(x::templates::AnimationKey* x_animation_key, const string_t& referenced_bone, model::Skeleton* skeleton, model::Animation* animation, const dword_t frame_diff, const dword_t last_frame_time);
