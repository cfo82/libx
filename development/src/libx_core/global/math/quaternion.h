...
public:
	...
	inline void ToRotationMatrix(Matrix3x3<TypeT>& mat) const
	{
		...
		mat.data.elements._11 = 1.0f - (f2yy + f2zz);
		mat.data.elements._12 = f2xy - f2wz;
		mat.data.elements._13 = f2xz + f2wy;
		
		mat.data.elements._21 = f2xy + f2wz;
		mat.data.elements._22 = 1.0f - (f2xx + f2zz);
		mat.data.elements._23 = f2yz - f2wx;
		
		mat.data.elements._31 = f2xz - f2wy;
		mat.data.elements._32 = f2yz + f2wx;
		mat.data.elements._33 = 1.0f - (f2xx + f2yy);
	}
