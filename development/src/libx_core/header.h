...
typedef uint_t (*io_tell_function_t)(void* io_token);
typedef bool_t (*io_eof_function_t)(void* io_token);
typedef int_t (*io_read_function_t)(ubyte_t* const buffer, const uint_t size, void* io_token);
typedef int_t (*io_write_function_t)(const ubyte_t* const buffer, const uint_t size, void* io_token);
...
public:
	...
	//-------------------------------------------------------------------------------------------------------
	const bool_t Read(io_read_function_t read_function, void* io_token);
	const bool_t Write(io_write_function_t write_function, void* io_token);
	const bool_t CheckMagic() const;
