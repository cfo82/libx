...
protected:
	...
	bool_t ReadData(TemporalInfo& info, ubyte_t* const buffer, const uint_t count);
...
protected:
	...
	// buffering data (will be needed to decompress data into the buffer)
	ubyte_t* buffer_;
	uint_t buffer_index_;
	uint_t buffer_size_;
};
